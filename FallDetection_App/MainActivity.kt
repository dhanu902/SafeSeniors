...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    // STATE TRACKER FOR YOUR NEW LOGIC
    ...
    private fun runInference(sensorData: List<FloatArray>) {
        ...
        // ==========================================
        // If the model predicts Fall (0), but we are currently Idle (1)
        if (maxIndex == 0 && lastUIState == 1) {
            // Override to Motion (2) to prevent the sudden jump
            maxIndex = 2
        }

        // Update our tracker before applying the UI
